...
class Contact extends Component{
    ...
    validate(firstname,lastname,telnum,email){
        ...
        errors.firstname = "First name should atleast be three characters";
            else if(this.state.touched.firstname && firstname.length>10)
            errors.firstname = "First name should be less than 10 characters";
        
            if(this.state.touched.lastname && lastname.length<3)
            errors.lastname = "Last name should atleast be three characters";
                else if(this.state.touched.lastname && lastname.length>10)
                errors.lastname = "Last name should be less than 10 characters";   
              
         const reg = /^\d+$/;
         if(this.state.touched.telnum && !reg.test(telnum))
         errors.telnum = "Telephone Numbrs should contain only numbers !";
